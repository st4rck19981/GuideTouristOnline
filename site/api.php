<?php
    ...
    $latitud=(float)latitud($indice);
    $longitud=(float)longitud($indice);
  ...
  <head>
    ...
    <script>
      $(document).ready(function() {
        $("#mapa12345").goMap({
          latitude:<?php echo $latitud; ?>,
          longitude:<?php echo $longitud; ?>,
          zoom:18,
          //maptype:"TERRAIN",
          scaleControl:true
        });
  ...
  <body>
    ...
    <div class="container" >
      <div class="row border border-dark rounded" style="padding-top:10px;padding-bottom:10px">
        <style>
          i.ex1:hover {color:Gold;}, i.ex1:active {<?php darvaloracionLugar($indice,1); ?> }
          i.ex2:hover {color:Gold;}, i.ex2:active {<?php darvaloracionLugar($indice,1); ?> }
          i.ex3:hover {color:Gold;}, i.ex3:active {<?php darvaloracionLugar($indice,1); ?> }
          i.ex4:hover {color:Gold;}, i.ex4:active {<?php darvaloracionLugar($indice,1); ?> }
          i.ex5:hover {color:Gold;}, i.ex5:active {<?php darvaloracionLugar($indice,1); ?> }
