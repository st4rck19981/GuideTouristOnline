      ...
      if(!empty($imagen_content_fullAndEncoded)){
       ...
       $todo='';
          ...
          if ($labels){
            ...
            //  print("&emsp; &#9745; $result[text] <br>");    
              $todo .= "-".$result['text']."n"; 
                ...
                echo $todo;  
                  header("Location: http://localhost/guidetourist/site/ejecutar.php?mensaje=".$todo);
                  exit;
        ...
        $indice=indiceLugar($nombre);
          ...
          //  print("Longitud: $longitude<br>");// die; 
            ?>
    ...
    */
    ...
    <div class="container">
      <div class="row">
        <div class="col-12">
            <div class="jumbotron">
              <h1 class="display-7">COMENTARIOS <?php echo $indice ?> </h1>
